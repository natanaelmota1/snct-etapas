...
def detect(frame):
    ...
    faces = faceCascade.detectMultiScale(frame_processed, minNeighbors=8)
    bboxes = []
    for (x, y, w, h) in faces:
        ...
        cv2.rectangle(frame_original, (cvRect[0], cvRect[1]), (cvRect[2], cvRect[3]), (0, 255, 0),
                      int(round(frame_height / 150)), 4)
    return frame_original, bboxes
